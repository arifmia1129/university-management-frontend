...
const AllCoursePage = () => {
  ...
  const { data, isLoading } = useGetOfferedCourseQuery({
    ...fetchQuery,
  });
  ...
  const columns = [
    {
      title: "Semester",
      render: (data: any) => {
        return data?.semesterRegistration?.academicSemester?.title;
      },
    },
    {
      title: "Course",
  ...
  return (
    <div>
      ...
      <ActionBar title="Manage Offered Courses">
        <Input
          value={searchTerm}
