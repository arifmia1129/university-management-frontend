...
const AllSemesterRegistration = () => {
  ...
  const { data, isLoading } = useGetSemesterRegistrationQuery({
    ...fetchQuery,
  });
  ...
  return (
    <div>
      ...
      <ActionBar title="Manage Semester Registration">
        <Input
          value={searchTerm}
      ...
      >
        <UMTable
          ...
          columns={columns}
          dataSource={data?.semesterRegistration}
...
export default AllSemesterRegistration;
